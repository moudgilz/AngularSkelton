export { MatDatepickerModule, MatDatepickerInputEvent } from '@angular/material/datepicker';
export { MAT_DATE_LOCALE, MatNativeDateModule, DateAdapter, NativeDateAdapter, MAT_DATE_FORMATS } from '@angular/material/core';
...
export { MatDialogRef, MAT_DIALOG_DATA, MAT_CHECKBOX_CLICK_ACTION, MatAutocompleteSelectedEvent } from '@angular/material';
...
export { MatSnackBarModule, MatSnackBar, MatSnackBarConfig } from '@angular/material/snack-bar';
